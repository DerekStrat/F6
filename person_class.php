<?php
    ...
    */
    ...
    class Person {
        ...
        function loadPerson() { // loading a person object in the database (editing)
            $this->createConn();
        ...
        function savePerson($InputID) { // update a person to the database (done in the edit_person.html)
            $this->createConn();
